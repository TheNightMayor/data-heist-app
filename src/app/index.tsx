...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 36, fontWeight: '900', color: '#22d3ee', marginTop: 16 },
  ...
  bigButtonText: { fontSize: 20, fontWeight: '800', color: '#fff' },
  bigButtonSub: { fontSize: 12, color: '#cffafe', marginTop: 4 },
  sectionHeader: {
    fontSize: 14,
    fontWeight: '700',
    color: '#64748b',
  ...
  mapName: { fontSize: 16, fontWeight: '700', color: '#f1f5f9' },
  mapDesc: { fontSize: 12, color: '#94a3b8', marginTop: 4 },
  mapMeta: { fontSize: 10, color: '#475569', marginTop: 4 },
  editBtn: {
    position: 'absolute',
    right: 12,
    top: 12,
